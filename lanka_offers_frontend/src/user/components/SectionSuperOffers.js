...
import "./SectionSuperOffers.css";

const SectionSuperOffers = (props) => {
  const settings = {
    autoplay: true,
    autoplaySpeed: 2000,
    arrows: false,
  ...
  return (
    <div>
      <section className="w3-row-padding w3-center w3-margin-bottom">
        <h6 className="w3-col s6 m6 l6 w3-left-align">Super Offers</h6>
        <Link to="/offers">
          <h6
...
export default SectionSuperOffers;
