...
const Dashboard = (props) => {
  return (
    <Fragment>
      <div>
        {/* Top container */}
        <div className="w3-bar w3-top w3-pink w3-large" style={{ zIndex: 4 }}>
          <button
          ...
          <span className="w3-bar-item w3-right">Lanka Offers</span>
        </div>
        <Sidemenu />
        ...
        >
          ...
          <div className="w3-row-padding w3-margin-bottom mt-4">
            ...
            <div className="w3-quarter">
              <div className="w3-container w3-grey w3-padding-16">
                <div className="w3-left">
            ...
            <div className="w3-quarter">
              <div className="w3-container w3-indigo w3-text-white w3-padding-16">
                <div className="w3-left">
          ...
          <br />
          <div className="w3-container w3-blue-grey w3-padding-32">
            <div className="w3-row">
          ...
          {/* Footer */}
          <footer className="w3-container w3-padding-16 w3-indigo">
            <h4>FOOTER</h4>
            <p>
              Powered by{" "}
              <a href="https://www.codevita.lk" target="_blank">
                CODEVITA
              </a>
            </p>
          </footer>
