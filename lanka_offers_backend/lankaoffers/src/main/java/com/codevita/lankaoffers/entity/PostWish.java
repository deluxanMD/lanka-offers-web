...
@Entity
@Table(schema = "lankaoffers", name = "postWishes")
public class PostWish {
	...
	public PostWish(Long id, Post post, PublicGuest publicGuest, Date createdAt, Date updatedAt, Date deletedAt) {
		super();
		this.id =id;
		this.post = post;
	...
	public PostWish(Post post, PublicGuest publicGuest, Date createdAt, Date updatedAt, Date deletedAt) {
		super();
		this.post = post;
		this.publicGuest = publicGuest;
		this.createdAt = createdAt;
