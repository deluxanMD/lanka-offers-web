...
@Entity
@Table(schema = "lankaoffers", name = "postReviews")
public class PostRating {
	...
	public PostRating(Long id, Post post, PublicGuest publicGuest, int rating,
	...
	public PostRating(Post post, PublicGuest publicGuest, int rating,
			String comment, Date createdAt, Date updatedAt, Date deletedAt)
	{
		super();
		this.post = post;
